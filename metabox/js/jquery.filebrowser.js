                        ...
                        if (!content) {
                            ...
                            current_content.files.forEach(function(file) {                                
                                if (typeof file === 'string') {
                                    ...
                                    var item = '<li id="'+ file.id +'" data-id="'+ file.id +'" class="file">'
                                    + '<span>' + file.name + '</span>'
                                    + '</li>';
                                    console.log('object', file, item);
                                    var $li = $(item).appendTo($ul).attr('draggable', true);
                                    console.log('item object', $li);
                                    if (file.name.match('.')) {
                                        $li.addClass(file.name.split('.').pop());
                                    }
                                    if (file.title) {
                                        $li.attr('title', file.title);
                                    }
                                }
